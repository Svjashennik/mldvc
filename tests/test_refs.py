...
import mldvc
from mldvc.refs import get_ref, is_detached, ref_resolve, resolve_head, update_ref
from mldvc.repo import repo_create


@unittest.skipIf(mldvc.__version_info__ < (0, 7, 0), "Нужна версия пакета 0.7.0 и выше")
